      ...
      <div>
        ...
        <p className='text-left w-5/6 p-3 mx-auto'>
          ...
          <div className='p-3 flex justify-center bg-white' data-aos='fade-up' data-aos-duration='1300'>
            <div className='flex justify-center bg-slate-300 rounded-xl lg:w-1/2 md:w-1/2 sm:w-3/5' style={{backgroundColor: '#748B6F', borderColor: '#2A403D'}}>
              ...
              <div className='flex flex-col items-center text-center'> 
                ...
                <div className='h-full rounded-bl-xl py-4 flex flex-col justify-evenly' style={{backgroundColor: '#e9e7e7', borderColor: '#748B6F'}}>
